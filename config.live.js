 ...
 * Config loaded from external source for security
 */

// This file will be populated by deployment script or fetched from secure endpoint
window.WIZARD_CONFIG = window.WIZARD_CONFIG || {
    ...
    SHOPIFY_ADMIN_API_TOKEN: 'PLACEHOLDER_TOKEN',  // Will be set by deployment
    SHOPIFY_API_VERSION: '2024-01',
    PRINTFUL_API_KEY: 'PLACEHOLDER_KEY',  // Will be set by deployment
    
    PRODUCT_MAPPING: {
        tshirt: {
            printful_id: 71,
            variant_mapping: {
                'black-S': 4012, 'black-M': 4013, 'black-L': 4014, 'black-XL': 4015,
                'white-S': 4016, 'white-M': 4017, 'white-L': 4018, 'white-XL': 4019
            },
            price: 1500
        },
        sweatshirt: {
            printful_id: 146,
            variant_mapping: {
                'black-S': 4320, 'black-M': 4321, 'black-L': 4322, 'black-XL': 4323,
                'navy-S': 4324, 'navy-M': 4325, 'navy-L': 4326, 'navy-XL': 4327
            },
            price: 2500
        },
        hat: {
            printful_id: 206,
            variant_mapping: {
                'black-one-size': 6897, 'navy-one-size': 6898, 'gray-one-size': 6899
            },
            price: 1200
        }
    }
...
// Override with real tokens (set during deployment or runtime)
if (window.location.hostname !== 'localhost') {
    // Production tokens - these will be injected by Vercel build or fetched from API
    window.WIZARD_CONFIG.SHOPIFY_ADMIN_API_TOKEN = window.WIZARD_CONFIG.SHOPIFY_ADMIN_API_TOKEN || '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';
    window.WIZARD_CONFIG.PRINTFUL_API_KEY = window.WIZARD_CONFIG.PRINTFUL_API_KEY || 'bhb2i3ltlsl3WEKoiXIGaytg7t83YtbnPkzGCccH';
}

console.log('✅ Config loaded:', {
    mode: window.WIZARD_CONFIG.PIXEL_ART_MODE,
    shopify: window.WIZARD_CONFIG.SHOPIFY_STORE_URL,
    hasToken: !!window.WIZARD_CONFIG.SHOPIFY_ADMIN_API_TOKEN
});
