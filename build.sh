#!/bin/bash
# Build script for Vercel deployment - injects real config
...
window.WIZARD_CONFIG = {
    ...
    SHOPIFY_ADMIN_API_TOKEN: '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',
    SHOPIFY_API_VERSION: '2024-01',
    PRINTFUL_API_KEY: 'bhb2i3ltlsl3WEKoiXIGaytg7t83YtbnPkzGCccH',
    PRODUCT_MAPPING: {
        tshirt: {
            printful_id: 71,
            variant_mapping: {
...
echo "✅ Config injected for production build"
