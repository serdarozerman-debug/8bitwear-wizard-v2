/**
 * 8BitWear Wizard - Configuration
 * WARNING: This file contains sensitive API keys. Never commit to git!
 */
...
window.WIZARD_CONFIG = {
    ...
    // Google Gemini API Key (for Nano Banana direct access)
    GEMINI_API_KEY: 'AIzaSyDHGv-v67en6HuUxHLY23c8VpjO1T0xThk',
    
    // Gemini Backend Proxy URL
    GEMINI_PROXY_URL: 'http://localhost:8003',
    
    // OpenAI Backend Proxy URL
    OPENAI_PROXY_URL: 'https://web-production-865f.up.railway.app',
    
    // Make.com Order Webhook URL (replaces n8n)
    N8N_ORDER_WEBHOOK_URL: 'https://hook.eu1.make.com/uunoeohfmx2j1ap35ufoik927twc9j69',  // Make.com: Webhook -> Google Sheets
    
    // Leonardo AI Generation Settings (optimized for cartoon pixel art)
    LEONARDO_CONFIG: {
        init_strength: 0.50,
        guidance_scale: 7,
        width: 1024,
        ...
        // PROMPT VARIANTS for "Tekrar Oluştur" (Safe for OpenAI moderation)
        prompts: [
            // VARIANT 1 (Structural focus - safe wording)
    ...
    // Pixel art mode: 'openai' (OpenAI Image Edit - production), 'gemini' (Nano Banana), 'leonardo' (fallback)
    ...
    // Shopify Admin API
    SHOPIFY_STORE_URL: '8bitwear-2.myshopify.com',  // ✅ CONFIGURED
    SHOPIFY_ADMIN_API_TOKEN: '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',  // ✅ CONFIGURED
    SHOPIFY_API_VERSION: '2024-01',  // API Version
    
    // Printful API
    PRINTFUL_API_KEY: 'bhb2i3ltlsl3WEKoiXIGaytg7t83YtbnPkzGCccH',  // ✅ CONFIGURED
    
    // Product Mapping (Printful Product IDs)
    PRODUCT_MAPPING: {
        tshirt: {
            printful_id: 71,  // Unisex Staple T-Shirt | Bella + Canvas 3001
            variant_mapping: {
                'black-S': 4012,
                'black-M': 4013,
                'black-L': 4014,
            ...
            price: 1500  // TL cinsinden (15.00 TL)
        },
        sweatshirt: {
            printful_id: 146,  // Unisex Heavy Blend Hooded Sweatshirt | Gildan 18500
            variant_mapping: {
                'black-S': 4320,
                'black-M': 4321,
                'black-L': 4322,
            ...
            price: 2500  // TL cinsinden (25.00 TL)
        },
        hat: {
            printful_id: 206,  // Embroidered Dad hat
            variant_mapping: {
                'black-one-size': 6897,
                'navy-one-size': 6898,
                'gray-one-size': 6899
            },
            price: 1200  // TL cinsinden (12.00 TL)
        }
    }
};
